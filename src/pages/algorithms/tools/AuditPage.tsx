...
export default function AuditPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Implementation Audit" category="Benchmark and Comparison" status="Educational">Track which algorithm pages are real browser implementations, custom visualizers, or educational substitutes.</PageHeader>
